					...
					echo "<div class='row col-md-push-1 col-md-10'>";
					  echo "<div class='text-center col-md-4'>";
					   echo"  <div class='thumbnail'>";
						...
						echo "<p><a href='traitementpanier.php?prod=$idproduit&page=$pagefooter&recherche=$objetrechercher&categorie=$categorie' class='btn btn-primary' role='button'>Ajouter au panier</a></p>";
					       echo "</div>";
					     echo "</div>";
					  echo "</div>";
				}
